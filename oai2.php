 ...
 */
//
// $Id: oai2.php,v 1.2 2010/01/21 16:49:04 jb23347 Exp $
//
...
$request = ' <request'.$reqattr.'>'.$OAI_CONFIG['MY_URI']."</request>\n";
$request_err = ' <request>'.$OAI_CONFIG['MY_URI']."</request>\n";

//if (is_array($OAI_CONFIG['compression'])) {
//    if (in_array('gzip', $OAI_CONFIG['compression']) && ini_get('output_buffering')) {
//        $compress = TRUE;
//    } else {
        $compress = FALSE;
//    }
