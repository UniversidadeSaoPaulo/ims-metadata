 ...
 */
//
// $Id: identify.php,v 1.2 2010/05/13 15:13:45 jmg324 Exp $
//
...
$indent = 2;
$output .= " <Identify>\n";
$output .= xmlformat($OAI_CONFIG['repositoryName'], 'repositoryName', '', $indent);
$output .= xmlformat($OAI_CONFIG['baseURL'], 'baseURL', '', $indent);
$output .= xmlformat($OAI_CONFIG['protocolVersion'], 'protocolVersion', '', $indent);
$output .= xmlformat($OAI_CONFIG['adminEmail'], 'adminEmail', '', $indent);
$output .= xmlformat($OAI_CONFIG['earliestDatestamp'], 'earliestDatestamp', '', $indent);
$output .= xmlformat($OAI_CONFIG['deletedRecord'],'deletedRecord', '', $indent);
$output .= xmlformat($OAI_CONFIG['granularity'], 'granularity', '', $indent);
$output .= xmlformat($OAI_CONFIG['compression'], 'compression', '', $indent);
...
if ($OAI_CONFIG['show_identifier'] && $OAI_CONFIG['repositoryIdentifier'] && $OAI_CONFIG['delimiter']) {
    $output .= ' <description>
   <oai-identifier xmlns="http://www.openarchives.org/OAI/2.0/oai-identifier"
    ...
    <scheme>oai</scheme>
    <repositoryIdentifier>'.$OAI_CONFIG['repositoryIdentifier'].'</repositoryIdentifier>
    <delimiter>'.$OAI_CONFIG['delimiter'].'</delimiter>
    <sampleIdentifier>'.$OAI_CONFIG['oaiprefix'].'id</sampleIdentifier>
   </oai-identifier>
  </description>'."\n";
}
